...
if(isset($_POST['save'])=='Update')
{
    ...
    {
        //update the values in table for id=$get_cat_id.
        $insert = "UPDATE category SET cat_title='$category' WHERE cat_id='$get_cat_id'";
        //if updated flag to show success div
        if(mysql_query($insert))
        {
            $f=1;
            $message1="Congratulation! A new information has been updated successfully.";
        }
...
<?php
        ...
        // query the table to get category infomation with id=$get_cat_id to display in form.
        $query1=mysql_query("select * from category where cat_id='$get_cat_id'");
        $result1=mysql_fetch_array($query1);
        $push_cat_title=$result1['cat_title'];
      ?>
     <!-- Example row of columns -->
      <div class="row">
        ...
        <div class="span12">
            ...
            <input class="span6" type="text" name="category" value="<?php echo $push_cat_title;?>">
            </div>
            </div>                
            <div class="span12">
