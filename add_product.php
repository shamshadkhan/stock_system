...
if(isset($_POST['save'])=='Save')
{
    ...
    {
        //insert into table
        $insert = 'INSERT INTO product(cat_id,prod_title,price,description)
        VALUES("'.$category.'","'.$product.'","'.$price.'","'.$description.'")';
...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="js/jquery.min.js"></script> 
     <script>
     //allow price field to take only integer (call this function in price input filed)
     ...
     <!-- Example row of columns -->
      <div class="row">
        ...
        <div class="span12">
            ...
            <div class="input-group">
            <input class="span6" type="text" name="product" required>
            </div>
            </div> 
             <div class="span12">
            <label>Product Price</label>
            <div class="input-group">
            <input class="span6" type="text" name="price" onkeydown="return numericOnly(event);" required>
            </div>
            </div> 
             <div class="span12">
            <label>Description</label>
            <div class="input-group">
            <textarea rows="3" class="span6" name="description" required></textarea>
            </div>
            </div>               
            <div class="span12">
