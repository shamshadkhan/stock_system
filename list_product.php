      ...
      <div class="row">
        ...
        <div class="span12">
            <table class="table table-bordered table-striped">
              <thead><tr><th width="140">Sl. Number</th><th>Category</th><th>Product</th><th>Price</th><th>Description</th><th width="40">Action</th><tr>
                </thead>
                <tbody>
                <?php
                ...
                if(isset($_POST['save'])=='Search')
                {
                     include("database.php");
                      ...
                      case when prod_title like '$search_product%' then 1 else 0 end>=2";
                      ...
                      if ($res_port) {
                         ...
                         while ($row_port = mysql_fetch_array($res_port)) {
                          ...
                          echo '<td class=" ">
                          <a href="edit_product.php?id='.$prod_id.'"><i class="icon-edit"></i></a>
                          <a href="delete_product.php?id='.$prod_id.'"><i class="icon-trash"></i></a></td>';
                          echo '</tr>';
                          $c++;
